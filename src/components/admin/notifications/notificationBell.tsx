...
export default function NotificationBell() {
    ...
    <div className="relative" ref={dropdownRef}>
      ...
      {/* Dropdown Panel */}
      {isOpen && (
        <div onClick={handleGoToNotifi} className="absolute right-0 mt-2 w-96 bg-white z-50  rounded-xl  shadow-lg border border-gray-200 overflow-hidden ">
          {/* Header */}
