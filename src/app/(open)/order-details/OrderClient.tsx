    ...
    <>
      <div className="min-h-screen bg-white dark:bg-[#0f0f0e] od-page-enter">
        ...
        <div className="max-w-xl mx-auto px-4 sm:px-6 py-10 space-y-4">
          ...
          {/* Header row */}
          <div className="flex items-center justify-between px-1 od-section" style={{ animationDelay: "0.05s" }}>
            <h1 className="text-base font-medium text-[#111110] dark:text-[#f5f5f3]">
              Order Summary
            </h1>
          ...
          {/* Status badge */}
          <div className="px-1 od-section" style={{ animationDelay: "0.08s" }}>
          ...
          {/* Items panel */}
          <div className="od-panel od-section" style={{ animationDelay: "0.1s" }}>
            <div className="flex items-center justify-between px-5 pt-5 pb-4 border-b border-[#f0f0ee] dark:border-[#1e1e1c]">
            ...
            <div>
              {order?.items?.map((item, idx) => (
                <div
                  key={item.id}
                  className="od-item-row flex items-center gap-4 px-5 py-4"
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="text-sm text-[#111110] dark:text-[#f5f5f3] truncate leading-snug">
                      {item.productName}
                    </p>
            ...
            {/* Total */}
            <div className="border-t border-[#f0f0ee] dark:border-[#1e1e1c] px-5 py-4">
              <div className="od-total-row">
                <span>Delivery</span>
                <span className="text-emerald-500 dark:text-emerald-400 text-xs font-mono">FREE</span>
              </div>
              <div className="od-divider my-3" />
              <div className="flex items-baseline justify-between">
                <span className="text-base font-normal text-[#111110] dark:text-[#f5f5f3]">Total</span>
                <span className="text-base font-mono text-[#111110] dark:text-[#f5f5f3]">
          ...
          {/* Actions */}
          <div className="space-y-3 od-section" style={{ animationDelay: "0.2s" }}>
