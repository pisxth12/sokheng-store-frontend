    ...
    return (
        <>
            ...
            <div className="border-b px-6 py-4 flex items-center justify-between">
                ...
                <span className="mono text-xs  tracking-widest uppercase">Checkout</span>
                <div className="w-12" />
            </div>
                        ...
                        {cart?.items?.map(item => (
                            <div key={item.id} className="item-row flex items-center gap-4 px-5 py-3.5">
                                ...
                                <div className="flex-1 min-w-0">
                                    ...
                                    <p className="text-xs  mt-0.5">${item.price} × {item.quantity}</p>
                                </div>
                                <p className="mono text-sm  shrink-0">${item.totalPrice.toFixed(2)}</p>
                            </div>
                        ))}
                    </div>
