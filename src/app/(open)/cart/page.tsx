...
export default function CartPage() {
  const { cart, updateQuantity, removeItem, loadCart, itemCount } = useCart();
          ...
          <div className="lg:col-span-4">
            <div className="divide-y divide-gray-100 dark:divide-[#2a2a27]">
              {cart.items.map((item, idx) => (
                ...
                >
                  {/* Image */}
                  <Link href={`/${item.categorySlug}/${item.slug}`} className="w-24 lg:w-40 h-24 lg:h-40 bg-gray-50 dark:bg-[#1a1a18] shrink-0 cp-img-wrap">
                    {item.productImage ? (
            ...
            <div className="sticky top-24 p-6 cart-sumury-body">
              ...
              <div className="space-y-3">
                <div className="flex justify-between text-sm">
                  <span className="text-gray-500 dark:text-gray-400">Subtotal ({itemCount} {itemCount === 1 ? 'item' : 'items'})</span>
              ...
              <button
                ...
                className="cp-checkout-btn mt-6 w-full py-3.5 bg-gray-900 dark:bg-white text-white dark:text-gray-900 text-xs font-medium tracking-widest uppercase flex items-center justify-center gap-2"
              >
