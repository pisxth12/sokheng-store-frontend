            ...
            <div className="account-card bg-white dark:bg-darkbg rounded-md shadow-sm border border-gray-200 dark:border-gray-800 p-6">
              ...
              <div className="space-y-1">
                {[
                  ...
                  { icon: CreditCard, label: t('quickActions.findYourOrder') ,href: '/track-order' },
                ].map((item) => (
                  <Link
                    key={item.label}
                    href={item.href}
          ...
          <div className="account-right md:w-80 space-y-6">
            ...
            <div className="account-card bg-white dark:bg-darkbg rounded-md shadow-sm border border-gray-200 dark:border-gray-800 p-6">
              ...
              <div className="space-y-3">
                <div className="account-setting-row flex items-center justify-between p-3  rounded-xl">
                ...
                <div className="account-setting-row p-3  rounded-xl">
                  <LanguageToggle />
                </div>
