...
import { Brand, BrandSelection, BrandStats, } from "@/types/admin/brand.type";
...
export const adminBrandApi = {
  ...
  selectBrands: async (): Promise<BrandSelection[]> => {
    const res = await apiClient.get<BrandSelection[]>(`/admin/brands/selections`);
    return res.data;
  },
