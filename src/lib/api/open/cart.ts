import { AddToCartRequest, CartResponse, UpdateCartItemRequest, CheckoutRequest } from "@/types/open/cart.type"
...
export const publicCartApi = {
    ...
    updateCartItem: async(itemId: number, data: UpdateCartItemRequest): Promise<CartResponse> => {
        ...
        const res = await apiClient.put<CartResponse>(`/cart/update/${itemId}`, data);
        return res.data;
    },
